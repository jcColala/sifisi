   					...
   					<div class="form-group form-row">
   							...
   							<div class="select2-idresponsable_{{$prefix}} div-select2 input-group mt-10px">
								...
								<div class="col-md-12">
									<div class="wrap-input100 mrginput100 validate-input">
										...
										<textarea name="proveedores" class="input100" id="proveedores_{{$prefix}}" placeholder="¿Quién provee las entradas? Pueden ser internos o externos" cols="30" rows="5"
										disabled></textarea>
										<span class="focus-input100"></span>
										<span class="symbol-input100">
								...
								<div class="col-md-12">
									<div class="wrap-input100 mrginput100 validate-input">
										...
										<textarea name="entradas" class="input100" id="entradas_{{$prefix}}" placeholder="¿Qué insumos se necesitan para realizar el proceso nivel 1?" cols="30" rows="5" disabled></textarea>
										<span class="focus-input100"></span>
										<span class="symbol-input100">
											<i class="fa fa-align-justify" aria-hidden="true"></i>
										</span>
								...
								<div class="col-md-12">
									<div class="wrap-input100 mrginput100 validate-input">
										...
										<textarea name="salidas" class="input100" id="salidas_{{$prefix}}" placeholder="¿Qué bienes y servicios genera el proceso nivel 1?" cols="30" rows="5"
										disabled></textarea>
										<span class="focus-input100"></span>
										<span class="symbol-input100">
											<i class="fa fa-align-justify" aria-hidden="true"></i>
								...
								<div class="col-md-12">
									<div class="wrap-input100 mrginput100 validate-input">
										...
										<textarea name="clientes" class="input100" id="clientes_{{$prefix}}" placeholder="¿Quién o quienes reciben los bienes y servicios generados por el proceso? Pueden ser internos o externos" cols="30" rows="5"
										disabled></textarea>
										<span class="focus-input100"></span>
										<span class="symbol-input100">
											<i class="fa fa-align-justify" aria-hidden="true"></i>
						...
						<div class="col-md-4">
   							<div class="select2-idelaborado_{{$prefix}} div-select2 input-group mt-10px">
								...
								<select class="form-control select2-show-search" id="idelaborado_{{$prefix}}" name="idelaborado" data-placeholder="Selecciona el que elaboró el proceso*" style="width:100%;" disabled >
									<option label="Selecciona el que elaboró el proceso"></option>
									@foreach($entidades as $value)
		                            	<option value="{{$value->id}}">{{$value->descripcion}}</option>
		                        	@endforeach
						...
						<div class="col-md-4">
   							<div class="select2-idrevisado_{{$prefix}} div-select2 input-group mt-10px">
								...
								<select class="form-control select2-show-search" id="idrevisado_{{$prefix}}" name="idrevisado" data-placeholder="Selecciona el que revisó el proceso*" style="width:100%;" disabled >
						...
						<div class="col-md-4">
							   ...
							   <span><b>APROBADO POR:</b></span>
								<select class="form-control select2-show-search" id="idaprobado_{{$prefix}}" name="idaprobado" data-placeholder="Selecciona el que aprobó el proceso*" style="width:100%;" disabled >
