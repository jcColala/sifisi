<div class="modal fade" id="md-modulo_padre" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
                        ...
                        <div class="col-md-5">
                        	<div class="input-group mt-10px">
								<div class="input-group-text mticono_form">
									<i id="form-icono-modulo_padre"></i>
								</div>
								<input type="text" class="form-control pull-right" id="icono" name="icono" placeholder="Icono*" onkeyup="text_icono(event,this,'icono','modulo_padre')">
			...
			<div class="modal-footer border-0">
				<button type="button" onclick="md_guardar(event,this)" class="btn btn-primary" data-acciones="guardar-modulo_padre">Guardar</button>
...
<script src='{{asset("js/form/modulo_padre/script.js")}}'></script>
