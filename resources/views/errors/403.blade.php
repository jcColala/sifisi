            ...
            <div class="page-content error-page">
                <div class="container text-center">
                    <div class="error-template">
                        <h1 class="display-1 text-primary mb-2">403 <span class="text-transparent_primary fs-20">Ooops error !</span></h1>
                        <h5 class="error-details text-primary">
                            Lo sentimos, el usuario no tiene los permisos correctos.
                        </h5>
