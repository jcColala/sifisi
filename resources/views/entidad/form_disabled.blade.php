	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Ver Proceso Nivel 0</h5>
				...
				<div class="modal-body modal_body">
					...
					<div class="form-group form-row">
						...
						<div class="col-md-12">
							...
							<div class="wrap-input100 mrginput100 validate-input">
								<textarea class="input100" id="objetivo_{{$prefix}}" name="objetivo" placeholder="Describe el Objetivo del Proceso*" cols="30" rows="5"
								disabled></textarea>
								<span class="focus-input100"></span>
								<span class="symbol-input100">
						...
						<div class="col-md-12">
							<div class="wrap-input100 mrginput100 validate-input">
								<textarea name="alcance" class="input100" id="alcance_{{$prefix}}" name="alcance" placeholder="Describe el Alcance del Proceso*" cols="30" rows="5"
								disabled></textarea>
								<span class="focus-input100"></span>
								<span class="symbol-input100">
									<i class="fa fa-align-justify" aria-hidden="true"></i>
