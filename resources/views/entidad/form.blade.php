		...
		<div class="modal-content">
			...
			<form id="form-{{$pathController}}" onsubmit="md_guardar(event,'btn-save')" >
				...
				<div class="modal-body modal_body">
					...
					<div class="col-md-6"> 
		   							<div class="select2-idtipo_entidad_{{$prefix}} div-select2 mrginput100_form input-group mt-10px">
										<select class="form-control select2-show-search" id="idtipo_entidad_{{$prefix}}" name="idtipo_entidad" data-placeholder="Selecciona el tipo de proceso*" style="width:100%;" required >
											<option label="Selecciona el tipo de proceso"></option>
											@foreach($tipo_entidad as $value)
				                            	<option value="{{$value->id}}">{{$value->descripcion}}</option>
				                        	@endforeach
										</select>
                                    	<span class="focus-input100">Tipo de Proceso*</span>
										<span class="idtipo_entidad_{{$prefix}} zmdi zmdi-close-circle msj_error d-none riht_extraselect2" data-toggle="popover" data-trigger="hover" data-class="popover_error" data-placement="top"></span>
									</div>
		                        </div>
						...
						<div class="col-md-6">
							<div class="wrap-input100 mrginput100 validate-input">
								...
								<span class="focus-input100">Nombre de la Entidad</span>
