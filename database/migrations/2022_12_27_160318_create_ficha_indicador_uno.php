...
class CreateFichaIndicadorUno extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sgc.ficha_indicador_uno', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sgc.ficha_indicador_uno');
    }
}
